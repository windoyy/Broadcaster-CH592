...
/**
 * @brief   Read temperature and humidity from SHT20 sensor.
 * 
 * @param temp  Pointer to temperature value (unit: 0.01°C).
 * @param humi  Pointer to humidity value (unit: 0.01%RH).
